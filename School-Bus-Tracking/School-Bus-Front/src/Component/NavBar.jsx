...
const toggleMobileSidebar = () => {
  ...
  if (sidebar) {
      if (!sidebar.classList.contains("show-mobile-sidebar") && !sidebar.classList.contains("hide-mobile-sidebar")) {
      ...
      {isMobileView && (
        <nav className="navbar navbar-light bg-light" style={{ position: "absolute", top: 0, left: 0, right: 0 }}>
          ...
          <button id="menu-btn" className="navbar-toggler"  type="button" onClick={toggleMobileSidebar}>
            ...
            <ul className="navbar-nav ms-auto">
              <li className="nav-item dropdown">
                <a className="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" style={{ color:"#2a2f5b" }}>
                  <img src="assets/img/profile.jpg" alt="Profile" className="rounded-circle" width="30" height="30"/>
                  <span className="ms-2" style={{ color:"#2a2f5b" }}>{user.firstName || "User"} {user.lastName}</span>
                </a>
                <ul className="dropdown-menu dropdown-menu-end" style={{ color:"#2a2f5b" }}>
                  <li><a className="dropdown-item" href="#" onClick={handleLogout} style={{ color:"#2a2f5b" }}>Logout</a></li>
                </ul>
              </li>
            </ul>
          </div>
